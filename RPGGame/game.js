...
let lvl_description = [
    ["Egy kis majom vagy és semmi több!", "majom.jpg"],
    ["Na végre! Két lábra álltál gratulálok!","osember.jpg"],
    ["Na! Még a végén lesz belőled valami! Nemes vagy el sem hiszem!!","nemes.jpg"],
    ["Wow egy asztronauta vagy és kijutottál az űrbe!", "asztronauta.jpg"]
];
...
function favagas(){
    ...
    if(szazalek <= 20){
        ...
        story.innerHTML += "Sikeres munka! (+1 tapasztalat)<br>";
        stats.experience += 1;
        refreshProfileStats();
    }
}
